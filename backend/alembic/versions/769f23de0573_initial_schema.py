...
Revision ID: 769f23de0573
Revises: 
Create Date: 2026-06-24 20:44:30.390267
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('horse_id', sa.BigInteger(), nullable=False),
    sa.Column('sire_id', sa.BigInteger(), nullable=True),
    sa.Column('dam_id', sa.BigInteger(), nullable=True),
    sa.Column('sire_sire_id', sa.BigInteger(), nullable=True),
