...
class Pedigree(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    horse_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("horses.id"), unique=True)
    sire_id: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey("horses.id"))
    dam_id: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey("horses.id"))
    sire_sire_id: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey("horses.id"))
...
class RaceEntry(Base):
    ...
    jockey_id: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey("jockeys.id"))
    trainer_id: Mapped[Optional[int]] = mapped_column(BigInteger, ForeignKey("trainers.id"))
